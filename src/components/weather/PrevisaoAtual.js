                    ...
                    <Collapse in={expand}>
                        <table className={styles.weathertab}>
                            <tr>
                                ...
                                <td className={styles.td2}>{parseInt(tempmax)}°C</td>
                            </tr>
                            <tr>
                                <td className={styles.td1}>Temp. Mínima</td>
                                <td className={styles.td2}>{parseInt(tempmin)}°C</td>
                            </tr>
                            <tr>
                                <td className={styles.td1}>Sensação Térmica</td>
                                <td className={styles.td2}>{parseInt(termica)}°C</td>
                            </tr>
                            <tr>
